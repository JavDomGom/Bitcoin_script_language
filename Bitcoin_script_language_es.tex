...
\section{Transacción \textit{Coinbase}}
    ...
    \noindent
    \begin{minipage}{0.50\textwidth}
        \includegraphics[scale=0.55]{img/Bitcoin_transactions_stack_02.png}
    \end{minipage}
