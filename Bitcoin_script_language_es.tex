...
\section{Estructura de datos de una transacción}
    ...
    En la siguiente imagen se muestra en detalle cada una de las partes que componen los segmentos de datos correspondientes a un \textit{input} y a un \textit{output}.
