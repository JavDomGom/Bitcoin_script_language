...
\section{Transacción \textit{Coinbase}}
    ...
    A continuación se tiene un \textit{byte} con valor \texttt{0x14} y representa el OP\_CODE \textbf{\texttt{OP\_PUSHBYTES\_20}}. Este introduce en a la pila los siguientes 20 \textit{bytes} que vienen a continuación en el segmento de datos \textit{scriptPubKey}, tal y como se muestra en la Figura 10
    ...
    \begin{minipage}{0.50\textwidth}
        ...
        \centering
            ...
            \caption{Adición de 20 \textit{bytes} a pila.}
        \end{figure}
    \end{minipage}
